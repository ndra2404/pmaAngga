                    ...
                    >
                        ...
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                <div class="mb-10">
                                    <p class="text-base font-bold leading-normal text-white-dark">PENERAPAN METODE PROFILE MATCHING TERHADAP PENILAIAN KINERJA KARYAWAN UNTUK REKOMENDASI KENAIKAN JABATAN</p>
                                ...
                                <form class="space-y-5 dark:text-white" action="" method="post">
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="Email" type="text" name="username" placeholder="Enter Username" class="form-input ps-10 placeholder:text-white-dark" />
...
<!-- Mirrored from html.vristo.sbthemes.com/auth-cover-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Aug 2023 23:18:37 GMT -->
</html>
